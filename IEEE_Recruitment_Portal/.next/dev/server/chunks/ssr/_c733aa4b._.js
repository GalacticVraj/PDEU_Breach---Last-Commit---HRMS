module.exports = [
"[project]/src/lib/data:406eea [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$406eea__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:406eea [app-ssr] (ecmascript) <text/javascript>");
...
function ResetDatabaseButton() {
    ...
    const handleReset = async ()=>{
        if (confirm('CRITICAL WARNING: This will delete ALL candidate data and members. Are you absolutely sure?')) {
            setIsLoading(true);
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$406eea__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["resetDatabase"])();
...
//# sourceMappingURL=_c733aa4b._.js.map