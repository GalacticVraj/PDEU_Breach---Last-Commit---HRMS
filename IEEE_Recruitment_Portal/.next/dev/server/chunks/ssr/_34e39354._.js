...
async function getCandidates() {
    ...
    return candidates.map((c)=>({
            ...
            interviewStartTime: c.interviewStartTime // if exists
        }));
}
...
async function addCandidates(newCandidates) {
    await db();
    // Validate uniqueness if needed, but for bulk add just push
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$models$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["CandidateModel"].insertMany(newCandidates);
...
async function submitScore(id, role, score) {
    ...
    if (candidate) {
        ...
        const s1 = currentScores.interviewer1;
        const s2 = currentScores.interviewer2;
        if (s1 && s2) {
            candidate.averageScore = (s1.total + s2.total) / 2;
            const r1 = s1.finalRating || s1.total / 5;
            const r2 = s2.finalRating || s2.total / 5;
            candidate.finalRatingAverage = parseFloat(((r1 + r2) / 2).toFixed(1));
            ...
            // Partial update, force save of usage
            candidate.scores = currentScores;
        }
        await candidate.save();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/interview/${id}`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/candidates');
...
"[project]/.next-internal/server/app/qbank/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/qbank/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
