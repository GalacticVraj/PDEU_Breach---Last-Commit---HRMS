...
const CandidateModal = ({ candidate, onClose, onOpenEmail }) => {
  ...
  const isGhost = candidate.ghost_status || ((candidate.status === 'Interviewing' || candidate.status === 'Offer') && candidate.lastActive?.includes('d') && parseInt(candidate.lastActive) >= 3);
