        ...
        <GlassCard className="p-6">
           <div className="flex items-center space-x-4 mb-6">
             ...
             <div>
               ...
               <p className="text-sm font-medium text-gray-500 mt-1">Simulated via AI</p>
             </div>
           </div>

           <div className="space-y-4 mb-6">
             <div>
               <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block">Profile URL or Native Export</label>
               <div className="flex space-x-2">
                 <input 
                   ...
                   className="flex-1 bg-[#F5F5F7] border border-glass-border rounded-xl px-4 py-3 text-gray-900 placeholder-[#636366] text-sm focus:outline-none focus:border-[#FF6B00]/50" 
                 />
                 <OrangeButton className="py-0 px-4 whitespace-nowrap font-bold shadow-[0_4px_12px_rgba(255,107,0,0.3)]">
                    Extract
                 </OrangeButton>
               </div>
             </div>
           ...
           <div className="border border-dashed border-glass-border rounded-xl p-4 text-center hover:border-[#FF6B00]/40 hover:bg-[#FF6B00]/5 transition-all cursor-pointer group">
             <Download size={20} className="mx-auto text-gray-400 group-hover:text-[#FF6B00] mb-2" />
             <p className="text-sm font-bold text-gray-900 mb-1">Bulk Import CSV</p>
             <p className="text-xs text-gray-500">Download LinkedIn Connections Export and upload here.</p>
           </div>
        </GlassCard>
